                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-4 text-center">
                                    <img src="{{ asset('image/logo.17d47cfe.svg') }}" width="180" alt="" />
                                </div>
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-primary"><a class="text-white no-underline" href="{{route('register')}}">Sign up</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
