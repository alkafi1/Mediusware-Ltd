...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <h3 class="card-title ">All Withdral Transaction</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table class="table table-borderd">
                                    ...
                                    @forelse ($transactions as $key=>$transaction)
                                        <tr>
                                            ...
                                            <td>{{ $transaction->fee }} BDT</td>
                                            <td>{{ $transaction->remaining_amount }} BDT</td>
                                            <td>{{ $transaction->created_at }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td class="text-center" colspan="5">There are no Transaction.</td>
                                        </tr>
                                    @endforelse
    ...
    <!-- Modal -->
    <div class="modal fade" id="Widthdralmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Withdral Form</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="card-body">
                        <form action="{{ route('widthdral.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 ">
                                ...
                                <div class="col-lg-12 mt-3">
                                    ...
                                    <input class="form-control" type="float" name="amount" value=""
                                        placeholder="Enter Your Widthdral Amount" />
                                    @error('amount')
